...
const taxAdvisors: TaxAdvisor[] = [
  // Featured - Nomad Capitalist FIRST
  { name: "Nomad Capitalist", specialty: ["Tax Optimization", "Flag Theory", "Second Citizenship", "Offshore Banking"], description: "The #1 holistic tax planning firm for location-independent entrepreneurs and high-net-worth individuals. Founded by Andrew Henderson, Nomad Capitalist provides personalized 'Go Where You're Treated Best' strategies covering legal tax reduction, second residencies, citizenship by investment, offshore banking, and global asset protection.", countries: ["Global Strategy"], region: "Global", email: "contact@nomadcapitalist.com", website: "https://nomadcapitalist.com", verified: true, features: ["Personalized Action Plans", "Flag theory implementation", "Banking & asset protection", "Investment migration", "Second citizenship", "Annual planning reviews"], rating: 4.9, clientType: ["nomad", "hnwi", "business", "freelancer"] },
  ...
  // Nomad Capitalist moved to top as featured
