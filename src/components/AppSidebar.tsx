...
const sidebarItems: SidebarItem[] = [
  ...
  { id: 'emergency-cards', label: 'Close Credit Card', icon: CreditCard, badge: 'SOS', variant: 'destructive' },
...
const AppSidebar: React.FC<AppSidebarProps> = ({ 
  ...
  const sidebarItemsTranslated = [
    ...
    { id: 'emergency-cards', label: t('nav.emergencyCards') || 'Close Credit Card', icon: CreditCard, badge: 'SOS', variant: 'destructive' as const },
