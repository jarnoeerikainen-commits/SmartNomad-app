...
const AppSidebar: React.FC<AppSidebarProps> = ({ 
  ...
  return (
    <>
      ...
      <aside className={`
        fixed left-0 z-[60] h-[calc(100dvh-4rem-env(safe-area-inset-top,0px)-4rem-env(safe-area-inset-bottom,0px))] w-[280px] max-w-[85vw] transform border-r bg-card shadow-large transition-transform duration-300 ease-in-out overflow-hidden
