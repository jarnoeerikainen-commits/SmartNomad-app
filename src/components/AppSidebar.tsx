  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'payment-options', label: 'Payment Options', icon: CreditCard, badge: 'NEW', variant: 'secondary' as const },
        { id: 'award-cards', label: 'Award Cards', icon: Award, badge: 'NEW', variant: 'secondary' as const },
