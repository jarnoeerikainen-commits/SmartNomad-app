  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'social-chat', label: 'Social Chat', icon: Users, badge: 'AI', variant: 'secondary' as const },
        { id: 'nomad-chat', label: 'Nomad Chat Groups AI', icon: MessageSquare, badge: 'AI', variant: 'secondary' as const },
