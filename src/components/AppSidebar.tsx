...
const sidebarItems: SidebarItem[] = [
  ...
  { id: 'emergency-cards', label: 'Emergency Cards', icon: CreditCard, badge: 'SOS', variant: 'destructive' },
...
const AppSidebar: React.FC<AppSidebarProps> = ({ 
  ...
  const sidebarItemsTranslated = [
    ...
    { id: 'emergency-cards', label: t('nav.emergencyCards') || 'Emergency Cards', icon: CreditCard, badge: 'SOS', variant: 'destructive' as const },
