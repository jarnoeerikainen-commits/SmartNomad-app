...
const result = (id: string, departureLocal: string): DemoBookingResult => ({
  ...
  order: {
    publicOrderId: id, supplier: 'Demo supplier', supplierOrderId: `supplier-${id}`, status: 'simulated', amount: 120, currency: 'USD',
    ...
    included: ['Cabin bag'], lineItems: [{ id: 'fare', label: 'Fare', amount: 120, currency: 'USD', mandatory: true }],
