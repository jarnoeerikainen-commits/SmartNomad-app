...
export const serviceCategories: ServiceCategory[] = [
  ...
  // Laundry Services (Priority 3)
  {
    id: 'l1',
    categoryName: 'Wash & Fold',
    categoryIcon: '👕',
    priority: 3,
    description: 'Professional wash and fold services',
    averageResponseTime: 48,
    providerCount: 0
  },
  {
  ...
  {
    id: 'l3',
    categoryName: 'Express Laundry',
    categoryIcon: '⚡',
    priority: 2,
    description: 'Same-day and express laundry services',
    averageResponseTime: 6,
    providerCount: 0
  },
  {
    id: 'l4',
    categoryName: 'Eco-Friendly Laundry',
    categoryIcon: '🌿',
    priority: 3,
    description: 'Environmentally conscious laundry services',
    averageResponseTime: 48,
    providerCount: 0
  },
];
...
export const majorCities: CityServiceData[] = [
  { cityName: 'Tokyo', countryCode: 'JPN', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 'l1', 'l2', 'l3'], providerCount: 245, topRatedProviders: [] },
  { cityName: 'Delhi', countryCode: 'IND', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 's1', 'l1'], providerCount: 189, topRatedProviders: [] },
  { cityName: 'Shanghai', countryCode: 'CHN', availableCategories: ['h1', 'm1', 'c1', 'c2', 'p1', 'p2', 'l1', 'l2'], providerCount: 198, topRatedProviders: [] },
  { cityName: 'São Paulo', countryCode: 'BRA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'p1', 's1', 'l1'], providerCount: 167, topRatedProviders: [] },
  { cityName: 'Mexico City', countryCode: 'MEX', availableCategories: ['h1', 'm1', 'c1', 'c2', 'p1', 'l1'], providerCount: 143, topRatedProviders: [] },
  { cityName: 'Cairo', countryCode: 'EGY', availableCategories: ['h1', 'm1', 'c1', 'p1'], providerCount: 98, topRatedProviders: [] },
  { cityName: 'Mumbai', countryCode: 'IND', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 's1', 'l1'], providerCount: 178, topRatedProviders: [] },
  { cityName: 'Beijing', countryCode: 'CHN', availableCategories: ['h1', 'm1', 'c1', 'c2', 'p1', 'l1', 'l2'], providerCount: 187, topRatedProviders: [] },
  { cityName: 'Dhaka', countryCode: 'BGD', availableCategories: ['h1', 'm1', 'c1', 'p1'], providerCount: 76, topRatedProviders: [] },
  { cityName: 'Osaka', countryCode: 'JPN', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 'l1', 'l2', 'l3'], providerCount: 156, topRatedProviders: [] },
  { cityName: 'New York', countryCode: 'USA', availableCategories: ['h1', 'h2', 'h3', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 's2', 's3', 'l1', 'l2', 'l4'], providerCount: 312, topRatedProviders: [] },
  ...
  { cityName: 'Los Angeles', countryCode: 'USA', availableCategories: ['h1', 'h2', 'h3', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 's2', 's3', 'l1', 'l2', 'l4'], providerCount: 289, topRatedProviders: [] },
  ...
  { cityName: 'Paris', countryCode: 'FRA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 'l1', 'l2', 'l4'], providerCount: 245, topRatedProviders: [] },
  ...
  { cityName: 'Bangkok', countryCode: 'THA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 'l1', 'l2', 'l3'], providerCount: 223, topRatedProviders: [] },
  { cityName: 'Seoul', countryCode: 'KOR', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 'l1', 'l2'], providerCount: 267, topRatedProviders: [] },
  ...
  { cityName: 'London', countryCode: 'GBR', availableCategories: ['h1', 'h2', 'h3', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 's2', 's3', 'l1', 'l2', 'l4'], providerCount: 298, topRatedProviders: [] },
  { cityName: 'Tehran', countryCode: 'IRN', availableCategories: ['h1', 'm1', 'c1', 'p1'], providerCount: 123, topRatedProviders: [] },
  { cityName: 'Chicago', countryCode: 'USA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 's3', 'l1', 'l2', 'l4'], providerCount: 234, topRatedProviders: [] },
  ...
  { cityName: 'Kuala Lumpur', countryCode: 'MYS', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 'l1', 'l2', 'l3'], providerCount: 189, topRatedProviders: [] },
  { cityName: 'Xi\'an', countryCode: 'CHN', availableCategories: ['h1', 'm1', 'c1', 'p1'], providerCount: 98, topRatedProviders: [] },
  { cityName: 'Hong Kong', countryCode: 'HKG', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 'l1', 'l2'], providerCount: 245, topRatedProviders: [] },
  ...
  { cityName: 'Madrid', countryCode: 'ESP', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 'l1', 'l2', 'l4'], providerCount: 223, topRatedProviders: [] },
  ...
  { cityName: 'Houston', countryCode: 'USA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 's1', 's3', 'l1'], providerCount: 198, topRatedProviders: [] },
  { cityName: 'Dallas', countryCode: 'USA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 's1', 'l1'], providerCount: 189, topRatedProviders: [] },
  { cityName: 'Toronto', countryCode: 'CAN', availableCategories: ['h1', 'h2', 'h3', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 's3', 'l1', 'l2', 'l4'], providerCount: 245, topRatedProviders: [] },
  { cityName: 'Dar es Salaam', countryCode: 'TZA', availableCategories: ['h1', 'm1', 'c1'], providerCount: 45, topRatedProviders: [] },
  { cityName: 'Miami', countryCode: 'USA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 'l1'], providerCount: 178, topRatedProviders: [] },
  { cityName: 'Belo Horizonte', countryCode: 'BRA', availableCategories: ['h1', 'm1', 'c1', 'c2', 'p1'], providerCount: 98, topRatedProviders: [] },
  { cityName: 'Singapore', countryCode: 'SGP', availableCategories: ['h1', 'h2', 'h3', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 's2', 's3', 'l1', 'l2', 'l3', 'l4'], providerCount: 289, topRatedProviders: [] },
  { cityName: 'Philadelphia', countryCode: 'USA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 's1', 'l1'], providerCount: 167, topRatedProviders: [] },
  { cityName: 'Atlanta', countryCode: 'USA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 's1', 'l1'], providerCount: 156, topRatedProviders: [] },
  ...
  { cityName: 'Barcelona', countryCode: 'ESP', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 'l1', 'l2', 'l4'], providerCount: 212, topRatedProviders: [] },
  ...
  { cityName: 'Washington', countryCode: 'USA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 's1', 'l1'], providerCount: 189, topRatedProviders: [] },
  ...
  { cityName: 'Melbourne', countryCode: 'AUS', availableCategories: ['h1', 'h2', 'h3', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 's3', 'l1', 'l2', 'l4'], providerCount: 234, topRatedProviders: [] },
  ...
  { cityName: 'Sydney', countryCode: 'AUS', availableCategories: ['h1', 'h2', 'h3', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 's3', 'l1', 'l2', 'l4'], providerCount: 256, topRatedProviders: [] },
  { cityName: 'Boston', countryCode: 'USA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 's1', 'l1', 'l2', 'l4'], providerCount: 178, topRatedProviders: [] },
  { cityName: 'Cape Town', countryCode: 'ZAF', availableCategories: ['h1', 'm1', 'c1', 'c2', 'p1', 's1'], providerCount: 145, topRatedProviders: [] },
  { cityName: 'Montreal', countryCode: 'CAN', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 's1', 'l1'], providerCount: 198, topRatedProviders: [] },
  { cityName: 'Jeddah', countryCode: 'SAU', availableCategories: ['h1', 'm1', 'c1', 'c2', 'p1'], providerCount: 112, topRatedProviders: [] },
  { cityName: 'Phoenix', countryCode: 'USA', availableCategories: ['h1', 'h2', 'm1', 'c1', 'c2', 'p1', 's1', 'l1'], providerCount: 145, topRatedProviders: [] },
  { cityName: 'San Francisco', countryCode: 'USA', availableCategories: ['h1', 'h2', 'h3', 'm1', 'c1', 'c2', 'p1', 'p2', 's1', 's3', 'l1', 'l2', 'l4'], providerCount: 278, topRatedProviders: [] },
...
export const sampleProviders: ServiceProvider[] = [
  ...
  {
    id: 'p6',
    businessName: 'Sudsy Premium Laundry',
    serviceCategories: ['l1', 'l2', 'l4'],
    description: 'Premium eco-friendly laundry service with pickup/delivery',
    countries: ['USA', 'CAN'],
    cities: ['New York', 'Los Angeles', 'Chicago', 'Toronto', 'San Francisco', 'Boston'],
    address: '789 Clean St, New York',
    contactInfo: {
      phone: '+1-555-LAUNDRY',
      email: 'care@sudsy.com',
      website: 'www.sudsy.com'
    },
    verificationStatus: 'verified',
    rating: 4.7,
    reviewCount: 250,
  ...
  {
    id: 'p7',
    businessName: 'HappyNest Laundry',
    serviceCategories: ['l1', 'l2', 'l3'],
    description: 'Asian premium laundry service with express options',
    countries: ['SGP', 'MYS', 'THA', 'JPN'],
    cities: ['Singapore', 'Bangkok', 'Tokyo', 'Kuala Lumpur', 'Osaka'],
    address: '456 Service Plaza, Singapore',
    contactInfo: {
      phone: '+65-6123-4567',
      email: 'care@happynest.sg',
      website: 'www.happynest.sg'
    },
    verificationStatus: 'verified',
    rating: 4.6,
    reviewCount: 320,
  ...
  {
    id: 'p8',
    businessName: 'Laundry Care Europe',
    serviceCategories: ['l1', 'l2', 'l4'],
    description: 'European premium laundry chain with eco-certification',
    countries: ['GBR', 'DEU', 'FRA', 'ESP', 'ITA', 'NLD'],
    cities: ['London', 'Berlin', 'Paris', 'Barcelona', 'Rome', 'Amsterdam'],
    address: '321 Euro Ave, London',
    contactInfo: {
      phone: '+44-20-7123-4567',
      email: 'service@laundrycare.eu',
      website: 'www.laundrycare.eu'
    },
    verificationStatus: 'verified',
    rating: 4.5,
    reviewCount: 280,
  ...
  {
    id: 'p9',
    businessName: 'Washmen Express',
    serviceCategories: ['l1', 'l2', 'l3'],
    description: 'Premium express laundry service across UAE with 2h turnaround',
    countries: ['ARE', 'SAU', 'QAT'],
    cities: ['Dubai', 'Abu Dhabi', 'Riyadh', 'Doha', 'Sharjah'],
    address: '555 Premium Plaza, Dubai',
    contactInfo: {
      phone: '+971-4-123-4567',
      email: 'hello@washmen.com',
      website: 'www.washmen.com'
    },
    verificationStatus: 'verified',
    rating: 4.7,
    reviewCount: 195,
  ...
  {
    id: 'p10',
    businessName: 'Cleanly Australia',
    serviceCategories: ['l1', 'l2', 'l4'],
    description: 'Professional laundry service with quality guarantee',
    countries: ['AUS'],
    cities: ['Sydney', 'Melbourne', 'Brisbane', 'Perth'],
    address: '123 Clean Way, Sydney',
    contactInfo: {
      phone: '+61-2-9123-4567',
      email: 'hello@cleanly.com.au',
      website: 'www.cleanly.com.au'
    },
    verificationStatus: 'verified',
    rating: 4.5,
    reviewCount: 167,
