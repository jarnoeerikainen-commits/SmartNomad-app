...
export const DEMO_AGENTIC_TRANSACTIONS: AgenticTransaction[] = [
  ...
  // Mumbai / India scenarios
  {
    id: 'atx-11',
    timestamp: '2026-04-14T11:00:00Z',
    protocol: 'x402',
    description: 'UPI One World wallet pre-load — ₹25,000 for Colaba shopping',
    amount: 0.04,
    currency: 'USDC',
    status: 'completed',
    merchant: 'NPCI UPI Gateway',
    category: 'api-call',
    aiInitiated: true,
    userApproved: false,
    cryptoNetwork: 'Base',
  },
  {
    ...
    protocol: 'visa-tap',
    description: 'BluSmart Premium — Navi Mumbai Airport to Taj Lands End',
    amount: 48,
    currency: 'USD',
    status: 'completed',
    merchant: 'BluSmart Premium',
    category: 'transport',
    aiInitiated: true,
    userApproved: true,
    trustScore: 96,
  },
  {
    ...
    protocol: 'stripe-issuing',
    description: 'Ayurveda cortisol-reset session — Dr. Patel, South Mumbai',
    amount: 180,
    currency: 'USD',
    status: 'completed',
    merchant: 'Veda Wellness Mumbai',
    category: 'booking',
    aiInitiated: true,
    userApproved: true,
    virtualCardLast4: '6190',
  },
  {
    id: 'atx-14',
    timestamp: '2026-04-12T09:00:00Z',
    protocol: 'mastercard-cloud',
    description: 'WeWork BKC — Monthly hot desk pass',
    amount: 200,
    currency: 'USD',
    status: 'completed',
    merchant: 'WeWork BKC Mumbai',
    category: 'subscription',
    aiInitiated: false,
    userApproved: true,
    trustScore: 94,
