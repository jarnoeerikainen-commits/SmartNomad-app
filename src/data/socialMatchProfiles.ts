...
export const JOHN_SPORTS_MATCHES: MatchEntry[] = [
  ...
  {
    id: 'john-hyrox-singapore',
    activity: 'HYROX Doubles Partner',
    activityEmoji: '🔥',
    city: 'Singapore',
    country: 'Singapore',
    countryCode: 'SG',
    when: 'Race May 18 · Train Tue/Thu 6AM',
    profile: { name: 'Daniel L.', age: 39, gender: 'male', avatar: avatars.m6, profession: 'Managing Director, PE Fund', verified: true },
    matchScore: 96,
    commonInterests: ['HYROX doubles', 'sled push', 'wall balls', 'executive athlete'],
    message: '🔥 HYROX match! Daniel (39, MD) needs a doubles partner for Singapore — 96% match!',
    voiceMessage: 'John, Daniel is a 39-year-old Managing Director looking for a HYROX doubles partner for the May 18th Singapore race. He trains Tuesdays and Thursdays at 6 AM. You\'re a 96% match.',
  },
  {
    id: 'john-chess-online',
    activity: 'Rapid Chess (15+10)',
    activityEmoji: '♟️',
    city: 'Singapore',
    country: 'Singapore',
    countryCode: 'SG',
    when: 'Evenings · Online + monthly meetup',
    profile: { name: 'Hiroshi T.', age: 46, gender: 'male', avatar: avatars.m7, profession: 'Hedge Fund PM', verified: true },
    matchScore: 92,
    commonInterests: ['rapid chess', 'engine prep', 'finance'],
    message: '♟️ Chess match! Hiroshi (46, Hedge Fund PM) plays 1900 rapid — 92% match!',
    voiceMessage: 'John, Hiroshi is a 46-year-old hedge fund portfolio manager rated around 1900 rapid. He hosts a monthly meetup at the Tanglin Club. 92% match on chess and finance.',
  },
];
