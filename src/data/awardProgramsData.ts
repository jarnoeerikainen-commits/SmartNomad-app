...
export const JOHN_AWARD_CARDS: UserAwardCard[] = [
  { id: 'jc-1', programId: 'sq-kf', programName: 'Singapore KrisFlyer', category: 'airline', memberNumber: 'SQ****4412', currentTier: 'PPS Club', pointsBalance: 310000, pointsCurrency: 'Miles', expiryDate: '2027-12-31', status: 'active', addedAt: '2024-01-01', lastUpdated: '2026-03-05', notes: 'STRATEGY: 310K miles = enough for Suites A380 SIN→LHR (244K Saver). Book 355 days before! PPS = The Private Room + Suites check-in. Seat 2A Suites (double bed). MAINTAIN PPS: Need S$7K more SQ revenue flights by Dec.' },
  { id: 'jc-2', programId: 'ua-mp', programName: 'United MileagePlus', category: 'airline', memberNumber: 'UA****2289', currentTier: 'Premier 1K', pointsBalance: 275000, pointsCurrency: 'Miles', status: 'active', addedAt: '2024-01-01', lastUpdated: '2026-03-02', notes: 'STRATEGY: 1K = GPU upgrade certificates for Polaris. Use for SFO routes. 275K miles for backup redemptions. Seat 6C Polaris (true aisle, 1-2-1). Polaris Lounge SFO.' },
  { id: 'jc-3', programId: 'lh-mm', programName: 'Lufthansa Miles & More', category: 'airline', memberNumber: 'LH****7723', currentTier: 'Senator', pointsBalance: 145000, pointsCurrency: 'Miles', expiryDate: '2027-06-30', status: 'active', addedAt: '2024-03-01', lastUpdated: '2026-02-28', notes: 'Munich & Zürich routes. Senator = First Class Lounge MUC. Seat 2A on A350. Book-the-Cook equivalent: pre-order meals.' },
  { id: 'jc-4', programId: 'aa-aadv', programName: 'American AAdvantage', category: 'airline', memberNumber: 'AA****6655', currentTier: 'Platinum Pro', pointsBalance: 165000, pointsCurrency: 'Miles', status: 'active', addedAt: '2024-02-01', lastUpdated: '2026-03-01', notes: 'STRATEGY: Latin America routes via DFW. 165K miles for SIN→GRU business. Transfer from Amex MR to top up. Flagship First Dining (DFW). Seat 5A on B787.' },
  { id: 'jc-13', programId: 'lx-mm', programName: 'SWISS Miles & More', category: 'airline', memberNumber: 'LX****8844', currentTier: 'Senator', pointsBalance: 0, pointsCurrency: 'Miles', status: 'active', addedAt: '2024-06-01', lastUpdated: '2026-02-15', notes: 'Shared Miles & More with LH. Senator Lounge ZRH. Seat 3A throne seat on A330. ZRH routes for ski trips.' },
  { id: 'jc-14', programId: 'vs-fc', programName: 'Virgin Atlantic Flying Club', category: 'airline', memberNumber: 'VS****3366', currentTier: 'Gold', pointsBalance: 65000, pointsCurrency: 'Points', status: 'active', addedAt: '2025-03-01', lastUpdated: '2026-02-20', notes: 'SWEET SPOT: Transfer to ANA for First Class at 110K points. Gold = Upper Class Wing access LHR.' },
  { id: 'jc-5', programId: 'mrt-bv', programName: 'Marriott Bonvoy', category: 'hotel', memberNumber: 'MB****1177', currentTier: 'Ambassador Elite', pointsBalance: 620000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-01-01', lastUpdated: '2026-03-06', notes: 'STRATEGY: Ambassador = personal ambassador at every RC/JW. 620K points → Ritz-Carlton Kyoto 5 nights (280K with 5th Night Free). W Verbier ski on points. Suite upgrades GUARANTEED.' },
  { id: 'jc-6', programId: 'hyatt-wh', programName: 'World of Hyatt', category: 'hotel', memberNumber: 'WH****5544', currentTier: 'Globalist', pointsBalance: 210000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-01-15', lastUpdated: '2026-03-04', notes: 'STRATEGY: Globalist = confirmed suite upgrades. Park Hyatt Zürich for ski (125K for 5 nights). Park Hyatt Singapore home base. Transfer from Chase UR 1:1 if needed.' },
  { id: 'jc-7', programId: 'shang-gc', programName: 'Shangri-La Golden Circle', category: 'hotel', memberNumber: 'SL****8833', currentTier: 'Diamond', pointsBalance: 85000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-06-01', lastUpdated: '2026-02-15', notes: 'Diamond = suite upgrades, late checkout, lounge access. Asia properties for family stays. Singapore flagship.' },
  { id: 'jc-15', programId: 'acc-all', programName: 'Accor Live Limitless', category: 'hotel', memberNumber: 'AL****7722', currentTier: 'Gold', pointsBalance: 18000, pointsCurrency: 'Points', status: 'active', addedAt: '2025-02-01', lastUpdated: '2026-02-10', notes: 'Sofitel, Swissôtel for Munich/Zürich backup. Gold = room upgrade + welcome drink.' },
  { id: 'jc-8', programId: 'chase-ur', programName: 'Chase Ultimate Rewards', category: 'credit-card', memberNumber: 'CSR****9012', currentTier: 'Sapphire Reserve', pointsBalance: 410000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-01-01', lastUpdated: '2026-03-07', notes: 'STRATEGY: Best transfer = Hyatt 1:1 (top up for Park Hyatt stays). Also United 1:1 for backup. CSR = 3x dining, travel. Priority Pass + 1.5x travel portal. 410K points = massive flexibility.' },
  { id: 'jc-9', programId: 'amex-mr', programName: 'Amex Membership Rewards', category: 'credit-card', memberNumber: 'AMEX****3456', currentTier: 'Platinum', pointsBalance: 285000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-01-01', lastUpdated: '2026-03-07', notes: 'STRATEGY: Transfer to SQ 1:1 for Suites backup. Transfer to ANA 1:1 for sweet spot awards. Centurion Lounge SFO + international. Use Platinum for 5x flights.' },
  { id: 'jc-16', programId: 'citi-typ', programName: 'Citi ThankYou Points', category: 'credit-card', memberNumber: 'CITI****7890', currentTier: 'Strata Premier', pointsBalance: 125000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-06-01', lastUpdated: '2026-03-05', notes: 'Transfer to Turkish (sweet spots), Singapore Airlines, Virgin Atlantic. Good for topping up smaller programs.' },
  { id: 'jc-10', programId: 'natl-em', programName: 'National Emerald Club', category: 'car-rental', memberNumber: 'NC****4455', currentTier: 'Executive Elite', pointsBalance: 8, pointsCurrency: 'Credits', status: 'active', addedAt: '2024-04-01', lastUpdated: '2026-02-20', notes: 'Emerald Aisle = choose any car in the aisle. Executive Elite = guaranteed upgrades. US rentals.' },
  { id: 'jc-11', programId: 'sixt-cc', programName: 'Sixt Card', category: 'car-rental', memberNumber: 'SX****6677', currentTier: 'Platinum', pointsBalance: 15000, pointsCurrency: 'Miles', status: 'active', addedAt: '2024-05-01', lastUpdated: '2026-02-01', notes: 'European rentals. Platinum = premium fleet, express pickup. Use for MUC/ZRH/ski transfers.' },
  { id: 'jc-12', programId: 'rcl-cr', programName: 'Royal Caribbean Crown & Anchor', category: 'cruise', memberNumber: 'RC****2211', currentTier: 'Platinum', pointsBalance: 48, pointsCurrency: 'Points', status: 'active', addedAt: '2025-01-01', lastUpdated: '2026-01-30', notes: 'Family cruises. Platinum = balcony discount + priority boarding. Planning summer Mediterranean cruise with kids.' },
  { id: 'jc-17', programId: 'db-bc', programName: 'Deutsche Bahn BahnCard', category: 'rail', memberNumber: 'DB-BC50', currentTier: 'BahnCard 50', pointsBalance: 4200, pointsCurrency: 'BahnBonus', status: 'active', addedAt: '2025-01-01', lastUpdated: '2026-02-15', notes: '50% off all DB trains. MUC→ZRH First Class. BahnBonus points for free tickets.' },
];
