...
export const MEGHAN_AWARD_CARDS: UserAwardCard[] = [
  { id: 'mc-1', programId: 'ba-ec', programName: 'British Airways Executive Club', category: 'airline', memberNumber: 'BA****8842', currentTier: 'Gold Guest List', pointsBalance: 247500, pointsCurrency: 'Avios', expiryDate: '2027-03-15', status: 'active', addedAt: '2024-01-15', lastUpdated: '2026-03-01', notes: 'Primary airline. Use for LHR short-haul & Oneworld partners.' },
  { id: 'mc-2', programId: 'ek-sk', programName: 'Emirates Skywards', category: 'airline', memberNumber: 'EK****3291', currentTier: 'Platinum', pointsBalance: 185000, pointsCurrency: 'Miles', expiryDate: '2027-06-30', status: 'active', addedAt: '2024-02-10', lastUpdated: '2026-02-28', notes: 'Dubai routes. Use for First Class upgrades.' },
  { id: 'mc-3', programId: 'sq-kf', programName: 'Singapore KrisFlyer', category: 'airline', memberNumber: 'SQ****7164', currentTier: 'Elite Gold', pointsBalance: 122000, pointsCurrency: 'Miles', expiryDate: '2027-01-20', status: 'active', addedAt: '2024-03-01', lastUpdated: '2026-02-15', notes: 'Singapore routes. Target Suites redemption.' },
  { id: 'mc-4', programId: 'ua-mp', programName: 'United MileagePlus', category: 'airline', memberNumber: 'UA****5590', currentTier: 'Premier 1K', pointsBalance: 198000, pointsCurrency: 'Miles', status: 'active', addedAt: '2024-01-01', lastUpdated: '2026-03-05', notes: 'US domestic & Star Alliance. Never expire.' },
  { id: 'mc-5', programId: 'mrt-bv', programName: 'Marriott Bonvoy', category: 'hotel', memberNumber: 'MB****4423', currentTier: 'Titanium Elite', pointsBalance: 485000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-01-01', lastUpdated: '2026-03-01', notes: 'Suite upgrades confirmed. Edition & W hotels.' },
  { id: 'mc-6', programId: 'hyatt-wh', programName: 'World of Hyatt', category: 'hotel', memberNumber: 'WH****2277', currentTier: 'Globalist', pointsBalance: 156000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-02-01', lastUpdated: '2026-02-20', notes: 'Best value! Park Hyatt suite upgrades.' },
  { id: 'mc-7', programId: 'acc-all', programName: 'Accor Live Limitless', category: 'hotel', memberNumber: 'AL****9901', currentTier: 'Platinum', pointsBalance: 42000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-06-15', lastUpdated: '2026-01-30', notes: 'Aman, Fairmont, Raffles bookings.' },
  { id: 'mc-8', programId: 'amex-mr', programName: 'Amex Membership Rewards', category: 'credit-card', memberNumber: 'AMEX****1234', currentTier: 'Platinum', pointsBalance: 320000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-01-01', lastUpdated: '2026-03-07', notes: 'Transfer to airlines for best value. Centurion Lounge access.' },
  { id: 'mc-9', programId: 'chase-ur', programName: 'Chase Ultimate Rewards', category: 'credit-card', memberNumber: 'CSR****5678', currentTier: 'Sapphire Reserve', pointsBalance: 195000, pointsCurrency: 'Points', status: 'active', addedAt: '2024-01-01', lastUpdated: '2026-03-07', notes: 'Transfer 1:1 to Hyatt = best value.' },
  { id: 'mc-10', programId: 'hertz-gc', programName: 'Hertz Gold Plus', category: 'car-rental', memberNumber: 'HZ****8800', currentTier: 'President\'s Circle', pointsBalance: 12500, pointsCurrency: 'Points', status: 'active', addedAt: '2024-05-01', lastUpdated: '2026-02-01', notes: 'Skip counter, free upgrades.' },
  { id: 'mc-11', programId: 'bk-gen', programName: 'Booking.com Genius', category: 'booking', currentTier: 'Level 3', pointsBalance: 0, pointsCurrency: 'Savings', status: 'active', addedAt: '2024-01-01', lastUpdated: '2026-03-01', notes: '20% off, free breakfast at partner hotels.' },
  { id: 'mc-12', programId: 'eurostar-cl', programName: 'Eurostar Club', category: 'rail', memberNumber: 'ES****3344', currentTier: 'Premier', pointsBalance: 8500, pointsCurrency: 'Points', status: 'active', addedAt: '2024-04-01', lastUpdated: '2026-01-15', notes: 'London-Paris Business Premier.' },
];
