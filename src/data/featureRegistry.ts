...
export const FEATURE_REGISTRY: FeatureItem[] = [
  ...
  { id: 'ees', label: 'EES Border Center', icon: Shield, category: 'tax', badge: 'LIVE', badgeVariant: 'default', description: 'Schengen Entry/Exit System — biometrics, 90/180 tracking, your data rights', defaultVisible: true, defaultPinned: true, trustLevel: 'advisory' },
  ...
  { id: 'lifestyle-hub', label: 'Lifestyle Intelligence', icon: Sparkles, category: 'premium', badge: 'AI', badgeVariant: 'secondary', description: 'Spotify, Oura, Garmin, Strava & WHOOP — music + fitness + skills feed the Concierge', defaultVisible: true, defaultPinned: false, trustLevel: 'actionable' },
