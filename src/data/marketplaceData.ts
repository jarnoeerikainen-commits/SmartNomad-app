...
const ITEM_TEMPLATES: ItemTemplate[] = [
  // FURNITURE (10) — avg ~138 EUR, ~60% off retail
  { title: 'IKEA Kallax 4x4 Shelf Unit', category: 'furniture', description: 'Excellent condition shelf unit, perfect for books and storage. Easy to disassemble for transport.', condition: 'good', priceEUR: 48, originalPriceEUR: 119, tags: ['furniture','shelf','ikea','storage'], dimensions: '147x147x39cm', weight: 40, image: 'https://images.unsplash.com/photo-1595428774223-ef52624120d2?w=800' },
  { title: 'Standing Desk - Electric Adjustable', category: 'furniture', description: 'Electric standing desk with memory presets. Promotes healthy posture and productivity. Smooth height adjustment.', condition: 'good', priceEUR: 180, originalPriceEUR: 449, tags: ['desk','standing-desk','office','work'], dimensions: '140x70cm', weight: 35, image: 'https://images.unsplash.com/photo-1595515106969-1ce29566ff1c?w=800' },
  { title: 'King Size Bed Frame with Mattress', category: 'furniture', description: 'Solid wood bed frame with premium memory foam mattress. Only months old. Must sell due to relocation.', condition: 'like-new', priceEUR: 299, originalPriceEUR: 749, tags: ['bed','furniture','bedroom','mattress'], dimensions: '200x180cm', image: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=800' },
  { title: 'Modern 3-Seater Sofa', category: 'furniture', description: 'Comfortable contemporary sofa, deep cushions, removable covers. Non-smoking home. Moving to smaller apartment.', condition: 'like-new', priceEUR: 259, originalPriceEUR: 649, tags: ['sofa','couch','furniture','living-room'], dimensions: '220x90x85cm', image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800' },
  { title: 'Extendable Dining Table - Seats 8', category: 'furniture', description: 'Beautiful wooden dining table, extends from 6 to 8 seats. Scandinavian design. Perfect for entertaining.', condition: 'good', priceEUR: 219, originalPriceEUR: 549, tags: ['table','dining','furniture','wood'], dimensions: '180-240x90cm', weight: 45, image: 'https://images.unsplash.com/photo-1530018607912-eff2daa1bac4?w=800' },
  { title: 'IKEA MALM Wardrobe with Mirror', category: 'furniture', description: 'Spacious wardrobe with sliding mirror door. Great storage for any bedroom. Clean, no scratches.', condition: 'good', priceEUR: 79, originalPriceEUR: 199, tags: ['wardrobe','ikea','bedroom','storage'], dimensions: '150x60x200cm', weight: 55, image: 'https://images.unsplash.com/photo-1558997519-83ea9252edf8?w=800' },
  { title: 'Bookshelf - Solid Oak', category: 'furniture', description: 'Handcrafted oak bookshelf, 5 shelves. Beautiful grain, very sturdy. Fits any living room or study.', condition: 'good', priceEUR: 99, originalPriceEUR: 249, tags: ['bookshelf','furniture','wood','storage'], dimensions: '90x30x180cm', weight: 30, image: 'https://images.unsplash.com/photo-1594620302200-9a762244a156?w=800' },
  { title: 'TV Stand / Media Console', category: 'furniture', description: 'Modern TV stand with cable management and storage drawers. Fits TVs up to 65". Minimalist design.', condition: 'like-new', priceEUR: 59, originalPriceEUR: 149, tags: ['tv-stand','furniture','living-room','media'], dimensions: '160x40x50cm', weight: 20, image: 'https://images.unsplash.com/photo-1615874959474-d609969a20ed?w=800' },
  { title: 'Office Desk with Drawers', category: 'furniture', description: 'Compact office desk with 3 drawers. Perfect for home office. Sturdy construction, minor wear.', condition: 'good', priceEUR: 67, originalPriceEUR: 169, tags: ['desk','office','furniture','work'], dimensions: '120x60x75cm', weight: 25, image: 'https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=800' },
  { title: 'Bar Stools Set of 4', category: 'furniture', description: 'Set of 4 industrial-style bar stools with footrest. Adjustable height. Great for kitchen island.', condition: 'good', priceEUR: 75, originalPriceEUR: 189, tags: ['stools','furniture','kitchen','bar'], weight: 20, image: 'https://images.unsplash.com/photo-1503602642458-232111445657?w=800' },

  // ELECTRONICS (8) — avg ~218 EUR, ~60% off retail
  { title: 'Samsung 55" 4K Smart TV', category: 'electronics', description: 'Crystal clear 4K, HDR, built-in streaming apps. Wall mount included. Moving internationally, must sell.', condition: 'like-new', priceEUR: 239, originalPriceEUR: 599, tags: ['tv','samsung','4k','electronics'], dimensions: '123x71cm', weight: 15, image: 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=800' },
  { title: 'iPad Pro 11" with Apple Pencil', category: 'electronics', description: 'iPad Pro with Apple Pencil 2nd gen and case. Always used with screen protector. Great for work and creativity.', condition: 'like-new', priceEUR: 479, originalPriceEUR: 1199, tags: ['ipad','apple','tablet','electronics'], weight: 0.5, image: 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=800' },
  { title: 'Sony WH-1000XM5 Headphones', category: 'electronics', description: 'Premium noise-cancelling headphones. Industry-leading ANC, 30h battery. Perfect for remote work and travel.', condition: 'like-new', priceEUR: 155, originalPriceEUR: 389, tags: ['headphones','sony','audio','noise-cancelling'], weight: 0.25, image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800' },
  { title: 'Nintendo Switch OLED Bundle', category: 'electronics', description: 'Switch OLED with 5 games, pro controller, and carrying case. Great condition. Fun for downtime between work.', condition: 'good', priceEUR: 179, originalPriceEUR: 449, tags: ['nintendo','gaming','switch','electronics'], weight: 0.9, image: 'https://images.unsplash.com/photo-1578303512597-81e6cc155b3e?w=800' },
  { title: 'Sonos One SL Speaker Pair', category: 'electronics', description: 'Two Sonos speakers for stereo sound. WiFi connected, works with all streaming services. Rich, clear audio.', condition: 'like-new', priceEUR: 169, originalPriceEUR: 429, tags: ['speaker','sonos','audio','smart-home'], weight: 3.6, image: 'https://images.unsplash.com/photo-1545454675-3531b543be5d?w=800' },
  { title: 'Canon EOS R50 Mirrorless Camera', category: 'electronics', description: 'Compact mirrorless camera with 18-45mm lens. 4K video, excellent autofocus. Includes bag and 64GB SD card.', condition: 'like-new', priceEUR: 359, originalPriceEUR: 899, tags: ['camera','canon','photography','electronics'], weight: 0.7, image: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=800' },
  { title: 'Apple AirPods Pro 2nd Gen', category: 'electronics', description: 'AirPods Pro with MagSafe case. Excellent noise cancellation and transparency mode. Under warranty.', condition: 'like-new', priceEUR: 109, originalPriceEUR: 279, tags: ['airpods','apple','earbuds','audio'], weight: 0.06, image: 'https://images.unsplash.com/photo-1606220588913-b3aacb4d2f46?w=800' },
  { title: 'Kindle Paperwhite + Case', category: 'electronics', description: 'Waterproof Kindle with adjustable warm light. Includes leather case and USB-C cable. Battery lasts weeks.', condition: 'like-new', priceEUR: 55, originalPriceEUR: 139, tags: ['kindle','ebook','reader','amazon'], weight: 0.2, image: 'https://images.unsplash.com/photo-1507842217343-583bb7270b66?w=800' },

  // KITCHEN (7) — avg ~89 EUR, ~60% off retail
  { title: 'Nespresso Vertuo Plus Coffee Machine', category: 'kitchen', description: 'Barely used Nespresso machine in excellent condition. Comes with capsule holder. Quick sale needed.', condition: 'like-new', priceEUR: 109, originalPriceEUR: 279, tags: ['coffee','kitchen','nespresso','appliances'], dimensions: '30x30x40cm', weight: 4.5, image: 'https://images.unsplash.com/photo-1517668808822-9ebb02f2a0e6?w=800' },
  { title: 'Instant Pot Duo 7-in-1', category: 'kitchen', description: 'Great condition pressure cooker, used only a few times. Includes manual and accessories. Perfect for busy nomads.', condition: 'like-new', priceEUR: 47, originalPriceEUR: 119, tags: ['kitchen','cooking','instant-pot','appliances'], dimensions: '32x32x31cm', weight: 5.5, image: 'https://images.unsplash.com/photo-1585515320310-259814833e62?w=800' },
  { title: 'KitchenAid Stand Mixer', category: 'kitchen', description: 'Iconic stand mixer with multiple attachments. Barely used. Includes dough hook, whisk, and paddle.', condition: 'like-new', priceEUR: 139, originalPriceEUR: 349, tags: ['kitchen','mixer','kitchenaid','baking'], weight: 10, image: 'https://images.unsplash.com/photo-1578237493287-8d3994143eae?w=800' },
  { title: 'Complete Kitchen Starter Pack', category: 'kitchen', description: 'Pots, pans, utensils, dishes for 6, cutlery, glasses. Everything you need. Clean and well-maintained.', condition: 'good', priceEUR: 59, originalPriceEUR: 149, tags: ['kitchen','cookware','dishes','bundle','starter-pack'], image: 'https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=800' },
  { title: 'Vitamix Blender E310', category: 'kitchen', description: 'Professional-grade blender for smoothies, soups, and sauces. Powerful motor, variable speed. Barely used.', condition: 'like-new', priceEUR: 159, originalPriceEUR: 399, tags: ['blender','vitamix','kitchen','smoothie'], weight: 5, image: 'https://images.unsplash.com/photo-1570222094114-d054a817e56b?w=800' },
  { title: 'Air Fryer - Philips XXL', category: 'kitchen', description: 'Large capacity air fryer, cooks for 4-6 people. Fat removal technology. Includes recipe booklet.', condition: 'good', priceEUR: 69, originalPriceEUR: 179, tags: ['air-fryer','kitchen','philips','cooking'], weight: 7, image: 'https://images.unsplash.com/photo-1648145853920-7b26cf0ebb0c?w=800' },
  { title: 'Microwave + Toaster Bundle', category: 'kitchen', description: 'Reliable Samsung microwave and Smeg toaster. Both work perfectly. Selling as bundle, prefer not to split.', condition: 'good', priceEUR: 39, originalPriceEUR: 99, tags: ['microwave','toaster','kitchen','bundle'], weight: 14, image: 'https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?w=800' },

  // WORK EQUIPMENT (6) — avg ~351 EUR, ~60% off retail
  { title: 'Dell UltraSharp 27" 4K Monitor', category: 'work-equipment', description: 'Professional 4K monitor, USB-C connectivity, height adjustable stand. Perfect for remote work.', condition: 'like-new', priceEUR: 269, originalPriceEUR: 679, tags: ['monitor','work','dell','4k','office'], dimensions: '61x36cm', weight: 6.8, image: 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=800' },
  { title: 'Herman Miller Aeron Chair - Size B', category: 'work-equipment', description: 'Premium ergonomic office chair, adjustable everything. Perfect working condition. The gold standard of office chairs.', condition: 'good', priceEUR: 379, originalPriceEUR: 949, tags: ['chair','office','herman-miller','ergonomic'], image: 'https://images.unsplash.com/photo-1580480055273-228ff5388ef8?w=800' },
  { title: 'MacBook Pro 16" M1 Pro', category: 'work-equipment', description: 'Powerful laptop for creative work. 16GB RAM, 512GB SSD. Includes charger and USB-C hub. AppleCare+ active.', condition: 'like-new', priceEUR: 1199, originalPriceEUR: 2999, tags: ['laptop','macbook','apple','computer','work'], weight: 2.1, image: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=800' },
  { title: 'Logitech MX Master 3S Mouse', category: 'work-equipment', description: 'Premium wireless mouse with MagSpeed scroll. USB-C rechargeable. Works on any surface including glass.', condition: 'like-new', priceEUR: 35, originalPriceEUR: 89, tags: ['mouse','logitech','office','work'], weight: 0.14, image: 'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=800' },
  { title: 'USB-C Docking Station', category: 'work-equipment', description: 'CalDigit TS4 Thunderbolt dock. 18 ports, dual 4K display support. Everything you need in one hub.', condition: 'like-new', priceEUR: 143, originalPriceEUR: 359, tags: ['dock','usb-c','thunderbolt','office'], weight: 0.6, image: 'https://images.unsplash.com/photo-1625842268584-8f3296236761?w=800' },
  { title: 'Webcam + Ring Light Kit', category: 'work-equipment', description: 'Logitech Brio 4K webcam with adjustable ring light and desk mount. Crystal clear video calls.', condition: 'like-new', priceEUR: 79, originalPriceEUR: 199, tags: ['webcam','ring-light','video','work'], weight: 1.2, image: 'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=800' },

  // TRANSPORTATION (5) — avg ~365 EUR, ~60% off retail
  { title: 'Canyon E-Bike Urban Commuter', category: 'transportation', description: 'High-quality electric bike, 80km battery range. Integrated lights, rear rack, fenders. Recently serviced.', condition: 'good', priceEUR: 959, originalPriceEUR: 2399, tags: ['e-bike','bicycle','electric','transportation'], image: 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=800' },
  { title: 'Xiaomi Electric Scooter Pro 2', category: 'transportation', description: 'Popular electric scooter, 45km range, 25km/h top speed. Foldable, easy to store. Great for city commuting.', condition: 'good', priceEUR: 179, originalPriceEUR: 449, tags: ['scooter','electric','xiaomi','transportation'], weight: 14.2, image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=800' },
  { title: 'Brompton Folding Bike', category: 'transportation', description: 'Iconic British folding bike, 6-speed. Folds in 20 seconds. Perfect for public transport + cycling combo.', condition: 'good', priceEUR: 559, originalPriceEUR: 1399, tags: ['bike','brompton','folding','transportation'], weight: 11, image: 'https://images.unsplash.com/photo-1507035895480-2b3156c31fc8?w=800' },
  { title: 'Skateboard - Loaded Boards', category: 'transportation', description: 'Premium longboard for cruising. Bamboo flex deck, Paris trucks, Orangatang wheels. Smooth ride.', condition: 'good', priceEUR: 79, originalPriceEUR: 199, tags: ['skateboard','longboard','transportation','sports'], weight: 3.5, image: 'https://images.unsplash.com/photo-1547447134-cd3f5c716030?w=800' },
  { title: 'Bike Lock + Lights + Helmet Bundle', category: 'transportation', description: 'Kryptonite U-lock, front/rear LED lights, and MIPS helmet (size M). Essential cycling safety kit.', condition: 'good', priceEUR: 47, originalPriceEUR: 119, tags: ['bike','safety','helmet','lock','lights'], weight: 2, image: 'https://images.unsplash.com/photo-1557803175-2f53559b93b1?w=800' },

  // BEDDING (4) — avg ~37 EUR, ~60% off retail
  { title: 'Complete Bedding Set - Queen', category: 'bedding', description: 'Premium cotton sheets, duvet, 4 pillows, mattress protector. All freshly laundered. Like new condition.', condition: 'like-new', priceEUR: 55, originalPriceEUR: 139, tags: ['bedding','sheets','pillows','bedroom'], image: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800' },
  { title: 'Bath Towel Set (8 pieces)', category: 'bedding', description: 'Luxury Egyptian cotton towels: 4 bath, 2 hand, 2 face. Soft, absorbent, barely used. White/grey.', condition: 'like-new', priceEUR: 29, originalPriceEUR: 75, tags: ['towels','bath','bathroom','linen'], image: 'https://images.unsplash.com/photo-1600369671854-7904de20c077?w=800' },
  { title: 'Blackout Curtains - 2 Panels', category: 'bedding', description: 'Heavy-duty blackout curtains, thermal insulated. 100% light blocking. Essential for jet lag recovery.', condition: 'like-new', priceEUR: 23, originalPriceEUR: 59, tags: ['curtains','blackout','bedroom','window'], image: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?w=800' },
  { title: 'Memory Foam Mattress Topper', category: 'bedding', description: 'Premium 7cm memory foam topper, queen size. Transforms any bed. Comes with removable washable cover.', condition: 'like-new', priceEUR: 39, originalPriceEUR: 99, tags: ['mattress','topper','bedroom','sleep'], dimensions: '200x150x7cm', weight: 8, image: 'https://images.unsplash.com/photo-1631049552057-403cdb8f0658?w=800' },

  // SPORTS (5) — avg ~222 EUR, ~60% off retail
  { title: 'Professional Road Bike - Carbon Frame', category: 'sports', description: 'High-end road bike, carbon fiber frame, Shimano 105 groupset. Recently serviced with new tires.', condition: 'good', priceEUR: 599, originalPriceEUR: 1499, tags: ['bike','bicycle','road-bike','carbon','sports'], image: 'https://images.unsplash.com/photo-1532298229144-0ec0c57515c7?w=800' },
  { title: 'Yoga Mat + Block Set', category: 'sports', description: 'Premium cork yoga mat with 2 blocks and strap. Non-slip, eco-friendly. Perfect for home or studio practice.', condition: 'like-new', priceEUR: 23, originalPriceEUR: 59, tags: ['yoga','mat','fitness','sports'], weight: 2.5, image: 'https://images.unsplash.com/photo-1601925260368-ae2f83cf8b7f?w=800' },
  { title: 'Adjustable Dumbbell Set (2-24kg)', category: 'sports', description: 'Space-saving adjustable dumbbells, replace 15 sets. Quick weight change mechanism. Perfect home gym.', condition: 'good', priceEUR: 139, originalPriceEUR: 349, tags: ['dumbbells','gym','fitness','weights'], weight: 48, image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800' },
  { title: 'Surfboard - 7ft Funboard', category: 'sports', description: 'Great all-round board for beginners and intermediates. Includes fins, leash, and board bag.', condition: 'good', priceEUR: 119, originalPriceEUR: 299, tags: ['surfboard','surfing','water-sports','beach'], weight: 5, image: 'https://images.unsplash.com/photo-1502680390548-bdbac40e8296?w=800' },
  { title: 'Peloton-Style Spin Bike', category: 'sports', description: 'Indoor cycling bike with tablet holder, adjustable resistance. Quiet belt drive. Great cardio at home.', condition: 'good', priceEUR: 229, originalPriceEUR: 579, tags: ['spin-bike','cycling','fitness','cardio'], weight: 40, image: 'https://images.unsplash.com/photo-1517963879433-6ad2b056d712?w=800' },

  // CLOTHING (5) — avg ~103 EUR, ~60% off retail
  { title: 'Winter Jacket Collection - Bundle', category: 'clothing', description: 'Bundle of 3 quality winter jackets: down jacket, waterproof shell, wool blend coat. Moving to warm climate.', condition: 'good', priceEUR: 119, originalPriceEUR: 299, tags: ['clothing','jackets','winter','bundle'], image: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800' },
  { title: 'Business Suits - Men\'s (2 pcs)', category: 'clothing', description: 'Two tailored suits: navy and charcoal. Wool blend, fits 40R. Dry cleaned and ready. Going fully remote.', condition: 'good', priceEUR: 159, originalPriceEUR: 399, tags: ['suits','clothing','business','formal'], image: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800' },
  { title: 'Designer Shoes Collection', category: 'clothing', description: 'Collection of 5 pairs: sneakers, boots, loafers, sandals, running shoes. Sizes EU 42-43. Good condition.', condition: 'good', priceEUR: 129, originalPriceEUR: 329, tags: ['shoes','clothing','footwear','bundle'], image: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=800' },
  { title: 'North Face Backpack 40L', category: 'clothing', description: 'Travel backpack with laptop sleeve, waterproof cover. Used on 2 trips. Perfect for digital nomad life.', condition: 'good', priceEUR: 49, originalPriceEUR: 129, tags: ['backpack','travel','north-face','bag'], weight: 1.4, image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800' },
  { title: 'Samsonite Cabin Suitcase', category: 'clothing', description: 'Hard-shell carry-on suitcase with spinner wheels and TSA lock. Fits all airline cabin specs. Like new.', condition: 'like-new', priceEUR: 59, originalPriceEUR: 149, tags: ['suitcase','luggage','travel','samsonite'], weight: 2.8, image: 'https://images.unsplash.com/photo-1565026057447-bc90a3dceb87?w=800' },
];
