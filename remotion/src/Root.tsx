...
export const RemotionRoot = () => (
  <>
    ...
    <Composition id="teaser-v2" component={TeaserV2} durationInFrames={975} fps={30} width={1920} height={1080} />
    <Composition id="ecosystem-v2" component={EcosystemV2} durationInFrames={3140} fps={30} width={1920} height={1080} />
  </>
);
