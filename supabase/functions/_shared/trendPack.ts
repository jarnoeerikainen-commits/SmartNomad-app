...
const FALLBACK_PACK: TrendPack = {
  ...
  sportsVocab: {
    ...
    crossfit: ["AMRAP", "EMOM", "RX'd", "scaled", "thruster", "Murph", "Fran time", "WOD", "box jump-over", "double-under"],
    hyrox: ["roxzone", "ski erg", "sled push", "sled pull", "burpee broad jump", "farmers carry", "sandbag lunges", "wall balls", "8x1k run", "split time"],
    ...
    chess: ["prep", "novelty", "engine line", "blitz nerves", "time scramble", "TCEC", "elo gain", "berserk", "premove", "zugzwang"],
    sailing: ["VMG", "tack-tack-tack", "lay line", "header", "puff"],
    triathlon: ["brick session", "T1", "T2", "draft legal", "pacing power", "70.3", "Kona slot", "negative split run", "open water sighting", "race-pace bike"],
